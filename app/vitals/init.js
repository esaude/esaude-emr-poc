angular.module('vitals', ['ngRoute', 'ngCookies', 'ui.router', 'smart-table', 'bahmni.common.uiHelper', 'bahmni.common.config', 
                        ...
                        'pascalprecht.translate', 'bahmni.common.i18n', 'patient.details', 'ngDialog']);

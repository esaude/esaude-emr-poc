...
describe('reportService', function () {
  ...
  beforeEach(function () {
    // Provide mock $compile and $timeout
    var element = {
  ...
  beforeEach(inject(function (_reportService_, _$httpBackend_, _$rootScope_, _$compile_, _$log_, _$q_, _$timeout_) {
  ...
  describe('generate patient ARV pickup history report', function () {
    ...
    beforeEach(function () {
      loadTemplate = $http.expectGET(PATIENT_ARV_PICKUP_HISTORY_REPORT_TEMPLATE)
    });
    ...
    it('should generate report', function () {
      ...
      reportService.printPatientARVPickupHistoryReport(patient);
      $http.flush();
    ...
    it('should cancel report generation if load fails', function () {
      ...
      reportService.printPatientARVPickupHistoryReport({});
      $http.flush();

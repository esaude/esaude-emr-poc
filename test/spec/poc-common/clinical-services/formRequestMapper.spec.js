...
describe('formRequestMapper', function () {
  ...
  var formRequestMapper;

  beforeEach(module('poc.common.clinicalservices'));

  beforeEach(inject(function (_formRequestMapper_) {
    formRequestMapper = _formRequestMapper_;
  }));
  ...
  describe('mapFromOpenMRSForm', function () {
    ...
    it('should map OpenMRS Form', function () {
      ...
      var mapped = formRequestMapper.mapFromOpenMRSForm(givenForm);
  ...
  describe('mapFromOpenMRSFormWithEncounter', function () {

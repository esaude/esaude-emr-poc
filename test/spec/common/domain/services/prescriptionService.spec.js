...
describe('prescriptionService', function () {
  ...
  describe('getPatientPrescriptions', function () {
        ...
        orders: [
          {
            ...
            duration: 1,
            durationUnits: {
              uuid: "9d96d012-10e8-11e5-9009-0242ac110012"
            },
      ...
      },
      {
        ...
        model: {
          answers: [
            ...
            {display: "Hour(s)", uuid: "9d956959-10e8-11e5-9009-0242ac110012"}
          ]
        },
    ...
    it('should get the patient prescriptions', function () {
      ...
      $rootScope.$apply();
      expect(loadedPrescriptions.encounterOrders.length).toEqual(encounters[0].orders.length);
